...
def generate_launch_description():
  ...
  pkg_share_folder = get_package_share_directory("walle_description")
    ...
    [
      generate_load_controller_launch_description(
        ...
        controller_params_file=join(
            pkg_share_folder, 'config', 'walle_controllers.yaml'))
    ],
  )

  # Load robot base controller
  base_controller = GroupAction(
    [
      generate_load_controller_launch_description(
        controller_name='walle_base_control',
        controller_params_file=join(
            pkg_share_folder, 'config', 'walle_controllers.yaml')
      )
    ],
  ...
  arm_pkg_share_folder = get_package_share_directory("walle_moveit_config")
